...
fn transcribe_batch(
    ...
    let extension = poha_audio_utils::content_type_to_extension(content_type);
...
pub(super) fn transcribe_recorded_file(
    ...
    let source = poha_audio_utils::source_from_path(audio_path)?;
...
fn transcribe_chunks(
    ...
    model: &mut poha_whisper_local::Whisper,
