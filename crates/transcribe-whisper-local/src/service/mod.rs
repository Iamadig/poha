...
pub(crate) fn build_model(
    ...
    params: &ListenParams,
) -> Result<poha_whisper_local::Whisper, crate::Error> {
...
pub(crate) fn load_model(
    model_path: &Path,
) -> Result<poha_whisper_local::LoadedWhisper, crate::Error> {
...
pub(crate) fn build_model_with_languages(
    loaded_model: &poha_whisper_local::LoadedWhisper,
    languages: Vec<poha_whisper::Language>,
) -> Result<poha_whisper_local::Whisper, crate::Error> {
...
fn build_chunk_segments(
    raw_segments: Vec<poha_whisper_local::Segment>,
    chunk_start_sec: f64,
