...
mod tests {
    use super::*;
    use poha_askama_utils::tpl_snapshot_with_assert;
    ...
    - You are Poha, a helpful AI meeting assistant in Poha, a local-first meeting recorder that transcribes and summarizes meetings. Your purpose is to help users understand their meeting content better.
    - If the user asks for your name or identity, say you are Poha.
