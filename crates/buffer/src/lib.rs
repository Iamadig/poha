...
## Stay Connected
- Follow updates on [X](https://github.com/Iamadig/poha).
- Join the community and chat on [Discord](https://github.com/Iamadig/poha/issues).

# Participants:

* [John Jeong](mailto:hello@example.com)
* [Yujong Lee](mailto:team@example.com)
...
"#;
    ...
    fn test_md_to_md_4() {
        let input = r#"
# Poha: Enhanced Meeting Notes

# Objective: Introduce Poha as a smart notepad for enhanced meeting productivity.
...
# Stay Connected: Promote Poha through X and Discord.
...
# Further Information: Follow updates on [X](https://github.com/Iamadig/poha) and [Discord](https://github.com/Iamadig/poha/issues).
        "#;

        insta::assert_snapshot!(md_to_md(input).unwrap().to_string(), @"# Further Information: Follow updates on [X](https://github.com/Iamadig/poha) and [Discord](https://github.com/Iamadig/poha/issues).");
    }
...
"#;
        ...
        <ul>
        <li>Follow updates on <a href="https://github.com/Iamadig/poha">X</a>.</li>
        <li>Join the community and chat on <a href="https://github.com/Iamadig/poha/issues">Discord</a>.</li>
        </ul>
        "#);
    }
