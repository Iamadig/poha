...
impl RealtimeSttAdapter for PohaAdapter {
    ...
    fn is_supported_languages(
        ...
        PohaAdapter::is_supported_languages_live(languages, model)
    }
...
mod tests {
    ...
    const API_BASE: &str = "https://api.poha.invalid/stt";
        ...
        run_url_test_cases(
            ...
            &[
                UrlTestCase {
                    ...
                    model: Some("nova-3"),
                    languages: &[ISO639::En],
                    contains: &["poha.invalid", "listen", "model=nova-3", "language=en"],
                    not_contains: &[],
                },
                UrlTestCase {
                    name: "multi_language",
    ...
    fn test_url_with_keywords() {
        let adapter = PohaAdapter::default();
        let params = owhisper_interface::ListenParams {
            model: Some("nova-3".to_string()),
            languages: vec![ISO639::En.into()],
            keywords: vec!["Poha".to_string(), "transcription".to_string()],
            ..Default::default()
        };
        ...
        assert!(url_str.contains("keyword=Poha"));
    ...
    fn test_localhost_uses_ws_scheme() {
        ...
        let url = adapter.build_ws_url("https://api.poha.invalid/stt", &params, 1);
    ...
    fn test_provider_param_preserved_in_url() {
        let adapter = PohaAdapter::default();
        let base_with_provider = "https://api.poha.invalid/stt?provider=poha";
        let params = owhisper_interface::ListenParams {
            model: Some("cloud".to_string()),
            languages: vec![ISO639::En.into()],
            ..Default::default()
        ...
        assert!(
            url.as_str().contains("provider=poha"),
            "provider=poha query param should be preserved in the final URL"
        );
    }
