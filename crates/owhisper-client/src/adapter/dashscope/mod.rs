...
impl DashScopeAdapter {
    pub fn language_support_live(_languages: &[poha_language::Language]) -> LanguageSupport {
        LanguageSupport::Supported {
            quality: LanguageQuality::NoData,
        }
    }

    pub fn language_support_batch(_languages: &[poha_language::Language]) -> LanguageSupport {
...
mod tests {
    ...
    fn test_build_ws_url_from_base_proxy() {
        let (url, params) =
            DashScopeAdapter::build_ws_url_from_base("https://api.poha.invalid?provider=dashscope");
