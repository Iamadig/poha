...
impl DeepgramModel {
    ...
    pub fn supports_language(&self, lang: &poha_language::Language) -> bool {
        lang.matches_any_code(self.supported_languages())
    }

    pub fn supports_multi(&self, languages: &[poha_language::Language]) -> bool {
...
impl DeepgramAdapter {
    pub fn find_model(languages: &[poha_language::Language]) -> Option<DeepgramModel> {
        if languages.len() >= 2 {
    ...
    fn can_use_multi(languages: &[poha_language::Language]) -> bool {
    ...
    fn single_language_support(language: &poha_language::Language) -> LanguageSupport {
    ...
    pub fn recommended_model_live(languages: &[poha_language::Language]) -> Option<&'static str> {
...
mod tests {
    ...
    fn test_model_supports_language() {
        let en: poha_language::Language = ISO639::En.into();
        let zh: poha_language::Language = ISO639::Zh.into();
    ...
    fn test_en_ca_with_nova3_general_not_supported() {
        let en_ca: poha_language::Language = "en-CA".parse().unwrap();
    ...
    fn test_en_us_with_nova3_general_supported() {
        let en_us: poha_language::Language = "en-US".parse().unwrap();
