...
pub fn can_use_multi(model: &str, languages: &[poha_language::Language]) -> bool {
    if languages.len() < 2 {
        return false;
    }
...
fn single_language_query_code(params: &ListenParams, language: &poha_language::Language) -> String {
