        ...
        match msg {
            AssemblyAIMessage::Begin { id, expires_at } => {
                tracing::debug!(
                    ...
                    poha.stt.provider_session.expires_at = %expires_at,
            ...
            AssemblyAIMessage::Termination {
                ...
                tracing::debug!(
                    poha.audio.duration_s = audio_duration_seconds,
                    poha.stt.provider_session.duration_s = session_duration_seconds,
