...
impl PyannoteAdapter {
    ...
    pub fn find_model(languages: &[poha_language::Language]) -> Option<PyannoteTranscriptionModel> {
...
mod tests {
    ...
    fn test_batch_api_url_preserves_nested_prefix() {
        let url = PyannoteAdapter::batch_api_url("https://api.poha.invalid/pyannote");
        assert_eq!(url.as_str(), "https://api.poha.invalid/pyannote/v1");
    }
