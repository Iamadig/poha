...
use poha_audio::{AudioProvider, CaptureFrame};

use pipeline::Pipeline;
use stream::start_source_loop;

use poha_device_monitor::{DeviceMonitorHandle, DeviceSwitch, DeviceSwitchMonitor};
...
pub struct SourceState {
    ...
    pub(super) audio_ready_emitted: bool,
