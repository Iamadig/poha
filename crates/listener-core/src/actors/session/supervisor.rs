...
pub struct SessionState {
    ...
    source_restarts: poha_supervisor::RestartTracker,
    recorder_restarts: poha_supervisor::RestartTracker,
    ...
    async fn pre_start(
        ...
        async {
            ...
            Ok(SessionState {
                ...
                listener_cell: None,
                recorder_cell,
                source_restarts: poha_supervisor::RestartTracker::new(),
                recorder_restarts: poha_supervisor::RestartTracker::new(),
                mode,
                shutting_down: false,
            })
        }
...
mod tests {
    ...
    use poha_audio::{AudioProvider, CaptureConfig, CaptureStream};
    use poha_supervisor::RestartTracker;
    ...
    impl AudioProvider for TestRuntime {
        fn open_capture(&self, _config: CaptureConfig) -> Result<CaptureStream, poha_audio::Error> {
            unimplemented!()
        }
        fn open_speaker_capture(
            ...
            _sample_rate: u32,
            _chunk_size: usize,
        ) -> Result<CaptureStream, poha_audio::Error> {
            unimplemented!()
        }
        fn open_mic_capture(
            &self,
        ...
        fn probe_mic(&self, _device: Option<String>) -> Result<(), poha_audio::Error> {
            Ok(())
        }
        fn probe_speaker(&self) -> Result<(), poha_audio::Error> {
            Ok(())
        }
    }
