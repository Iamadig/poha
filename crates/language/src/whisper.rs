...
impl TryInto<poha_whisper::Language> for Language {
    type Error = Error;

    fn try_into(self) -> Result<poha_whisper::Language, Self::Error> {
        use poha_whisper::Language as WL;
...
impl TryInto<Language> for poha_whisper::Language {
    type Error = Error;
