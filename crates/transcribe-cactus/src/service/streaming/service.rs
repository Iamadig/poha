...
type CactusModelManager = ModelManager<poha_cactus::Model>;
...
pub struct TranscribeService {
    ...
    health: poha_cactus::ServiceHealthTracker,
}
...
impl TranscribeServiceBuilder {
    ...
    pub fn build(self) -> TranscribeService {
        poha_cactus::init_runtime();
        let health = poha_cactus::ServiceHealthTracker::new();
