...
mod tests {
    ...
    fn keeps_plain_keywords_as_vocabulary() {
        ...
        assert_eq!(vocabulary, vec!["Poha", "project atlas"]);
    ...
    fn uses_strongest_positive_intensifier() {
        ...
        assert_eq!(vocabulary, vec!["Poha", "cactus"]);
