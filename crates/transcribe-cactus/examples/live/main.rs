...
use poha_audio::AudioProvider;
use poha_audio_actual::ActualAudio;
use poha_audio_mock::MockAudio;
...
/// Example:
/// cargo run -p transcribe-cactus --example live -- --model ~/Library/Application\ Support/poha/models/cactus/parakeet-tdt-0.6b-v3-int4 --audio mock --stream-chunk-sec 0.2 --min-chunk-sec 2.0
#[tokio::main]
async fn main() {
    let args = Args::parse();
