...
pub trait AudioFormatExt: AsyncSource {
    ...
    {
        poha_resampler::ResamplerDynamicOld::new(self, sample_rate)
            .chunks(chunk_size)
            .map(|chunk| {
...
pub use poha_audio_mime::content_type_to_extension;
...
mod tests {
    ...
    test_audio_file_metadata! {
        test_audio_file_metadata_wav: poha_data::english_1::AUDIO_PATH,
        test_audio_file_metadata_mp3: poha_data::english_1::AUDIO_MP3_PATH,
        test_audio_file_metadata_mp4: poha_data::english_1::AUDIO_MP4_PATH,
        test_audio_file_metadata_m4a: poha_data::english_1::AUDIO_M4A_PATH,
        test_audio_file_metadata_ogg: poha_data::english_1::AUDIO_OGG_PATH,
        test_audio_file_metadata_flac: poha_data::english_1::AUDIO_FLAC_PATH,
        test_audio_file_metadata_aac: poha_data::english_1::AUDIO_AAC_PATH,
        test_audio_file_metadata_aiff: poha_data::english_1::AUDIO_AIFF_PATH,
    }
