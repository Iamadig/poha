...
export type BatchProvider = "argmax" | "whispercpp" | "deepgram" | "soniox" | "assemblyai" | "fireworks" | "openai" | "gladia" | "elevenlabs" | "pyannote" | "dashscope" | "mistral" | "poha" | "am" | "cactus" | "aquavoice"
...
export type CaptureParams = { session_id: string; languages: string[]; mic_device?: string | null; onboarding: boolean; model: string; base_url: string; api_key: string; keywords: string[]; participant_human_ids?: string[]; self_human_id?: string | null }
